...
// Ejecuta este script con Node.js en tu backend (ajusta la conexión si es necesario)
  ...
  try {
    ...
    for (const usuario of results) {
      await EmpleadoModel.create({
        ...
        cargo: 'cajero', // Puedes cambiar el cargo si lo deseas
        telefono: '00000000' // Cambia por el teléfono real si lo tienes
      });
